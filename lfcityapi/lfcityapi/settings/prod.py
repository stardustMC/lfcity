...
CACHES = {
    'default': {
        ...
        'LOCATION': 'redis://123456@47.95.176.173:6379/0',
        'OPTIONS': {
    ...
    'session': {
        'BACKEND': 'django_redis.cache.RedisCache',
        'LOCATION': 'redis://123456@47.95.176.173:6379/1',
        'OPTIONS': {
            'CLIENT_CLASS': 'django_redis.client.DefaultClient',
            'CONNECTION_POOL_KWARGS': {
                'max_connections': 100,
    ...
    'sms_code': {
        'BACKEND': 'django_redis.cache.RedisCache',
        'LOCATION': 'redis://123456@47.95.176.173:6379/2',
        'OPTIONS': {
            'CLIENT_CLASS': 'django_redis.client.DefaultClient',
            'CONNECTION_POOL_KWARGS': {
                'max_connections': 100,
    ...
    'cart': {
        'BACKEND': 'django_redis.cache.RedisCache',
        'LOCATION': 'redis://123456@47.95.176.173:6379/3',
        'OPTIONS': {
            'CLIENT_CLASS': 'django_redis.client.DefaultClient',
            'CONNECTION_POOL_KWARGS': {
                'max_connections': 100,
    ...
    'coupon': {
        'BACKEND': 'django_redis.cache.RedisCache',
        'LOCATION': 'redis://123456@47.95.176.173:6379/4',
        'OPTIONS': {
            'CLIENT_CLASS': 'django_redis.client.DefaultClient',
            'CONNECTION_POOL_KWARGS': {
                'max_connections': 100,
...
# 任务队列
CELERY_BROKER_URL = 'redis://:123456@47.95.176.173:6379/14'
# 结果队列
CELERY_RESULT_BACKEND = 'redis://:123456@47.95.176.173:6379/15'
# 时区，与django的时区同步
